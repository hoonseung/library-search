...
public class ApplicationInitAfterRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        DailyStat stat5 = DailyStat.createEntity("HTTP", LocalDateTime.now());
        ...
        DailyStat stat8 = DailyStat.createEntity("JAVA", LocalDateTime.now());
        DailyStat stat9 = DailyStat.createEntity("JAVA", LocalDateTime.now());
        DailyStat stat10 = DailyStat.createEntity("JPA", LocalDateTime.now());
        DailyStat stat11 = DailyStat.createEntity("JPA", LocalDateTime.now());
        DailyStat stat12 = DailyStat.createEntity("Kotlin", LocalDateTime.now());
        DailyStat stat13 = DailyStat.createEntity("JPA", LocalDateTime.now());
        DailyStat stat14 = DailyStat.createEntity("Database", LocalDateTime.now());
        DailyStat stat15 = DailyStat.createEntity("Database", LocalDateTime.now());
